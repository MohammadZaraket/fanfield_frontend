...
## Hi there, This is Fanfield Project, a basic social media mock website.


### This project is done by Mohammad Zaraket & Ali Azzam

- 👯 we are looking to collaborate with other content developers
- 🥅 Our 2022 Goals: Learn more about Full-Stack Developement
...
<details>
  <summary>:zap: Project Activity</summary>
  
<!--START_SECTION:activity-->
1. 🎉 Started By Designing the potential Website User Interface using Figma.
2. 🎉 After That, Designing and Implementing MySQL Database Tables, and Inserting test data rows.
3. 🎉 Implementing APIs using PHP. PHP files that return JSON objects are implemented in different Repo called FanField_Backend in [AAAzzam1/fanfield_backend](https://github.com/AAAzzam1/fanfield_backend)
4. 🎉 Merged Two different Branches presenting website's Features
5. 🎉 Implementing Front End Files Integrating with the PHP back end APIs.
...
<details>
  ...
  <img align="center" alt="ProfiePage" src="" />
 ...
 ### The User can be directed to his/her Friends Page, Where the he/she can ADD/REMOVE a friend from the FRIENDS LIST, even he/she has the option to BLOCK/UNBLOCK other users.
  <img align="center" alt="FriendsPage" src="" />
